            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  <h3 class="fw-bold text-muted text-center mb-4">Buat Akun Baru</h3>
                  <div class="form-group">
                      <input id="fullname" type="text" name="fullname" required data-msg="Please enter your Name" class="input-material">
                      <label for="login-fullname" class="label-material">Nama Lengkap</label>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                      <label for="level" class="control-label">Level/Profesi User</label>
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                      <a href="<?php echo base_url('index.php/admin/index') ?>" class="text-decoration-none mr-3">Apakah akunmu sudah siap? Login sekarang</a>
