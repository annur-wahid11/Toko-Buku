            ...
            <div class="col-lg-6">
              <div class="info align-items-center">
                <div class="d-flex flex-column justify-content-center align-items-center h-100">
                  <h1 class="text-center">TOKO BUKU AAN</h1>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
              ...
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  <form method="post" class="form-validate" action="<?php echo base_url('index.php/admin/proses_login') ?>">
                        <h2 class="text-center mb-4 text-secondary">Login TOKO BUKU AAN</h2>
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                      <a href="<?php echo base_url('index.php/admin/register') ?>" class="text-decoration-none fw-bold mr-3">Register Akun Baru</a>
