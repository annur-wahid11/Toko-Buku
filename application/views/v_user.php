<header class="page-header">
  <div class="container-fluid">
    <h2 class="no-margin-bottom">Sistem User</h2>
  </div>
</header>
...
<div class="table-agile-info">
	<div class="panel panel-default">
		...
		<div class="container-fluid">
			...
			<br><a href="#add" data-toggle="modal" class="btn btn-primary pull-left"><i class="fa fa-plus"></i> Tambah Sistem User Baru</a><br>
				...
				<tbody style="background-color: white;">
					...
					<tr>
						...
						<td>
							...
							<a href="<?=base_url('index.php/user/hapus/'.$user->user_code)?>" onclick="return confirm('Are you sure to delete it?')" class="btn btn-danger btn-sm">Hapus</a>
						</td>
					</tr>
				<?php endforeach ?>
				</tbody>
				...
				<form action="<?=base_url('index.php/user/add')?>" method="post">
					<div class="modal-body">
						<div class="form-group row">
							<div class="col-sm-3 offset-1"><label>Nama</label></div>
							<div class="col-sm-7">
						...
						<div class="form-group row">
							<div class="col-sm-3 offset-1"><label>Level/Profesi</label></div>
							<div class="col-sm-7">
