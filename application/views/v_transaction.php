<header class="page-header">
  <div class="container-fluid">
    <h2 class="no-margin-bottom">Sales Transaksi</h2>
  </div>
</header>
<br>
<div class="container-fluid">
	<div class="row">
		<div class="col-md-7">
			<div class="card rouded-0 shadow">
				<div class="card-header">
					<div class="card-title mb-0">Daftar Buku</div>
				</div>
				<div class="card-body">
		...
		<div class="col-md-5">
			<div class="card rounded-0 shadow">
				<div class="card-header">
					<div class="card-title mb-0">Keranjang</div>
				</div>
				<div class="card-body">
					<form action="<?=base_url('index.php/transaction/save')?>" method="post">
					
						Admin/Kasir : <select name="user_code" class="form-control">
						...
						<?php foreach ($transaction as $transaction): ?>
							...
							Nama Customer : <input type="text" name="buyer_name" class="form-control"><br>
						...
						<?php endforeach  ?>
							...
							<th colspan="4">Total Persedian</th>
						...
						<a class="btn btn-danger rounded-0 btn-sm" href="<?=base_url('index.php/transaction/clearcart')?>">Bersihkan Keranjang</a>
						</div>
					</form>
