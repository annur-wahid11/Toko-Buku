...
<div class="table-agile-info">
		...
		<div class="card rounded-0 mt-3">
			<div class="card-header">
					<a href="#add" data-toggle="modal" class="btn btn-primary btn-sm rounded-0 pull-right"><i class="fa fa-plus"></i> Tambah Kategori Baru</a>
			</div>
			<div class="card-body">
					...
					<thead style="background-color: #464b58; color:white;">
						...
						<tr>
							...
							<td class="text-center">
								...
								<a href="<?=base_url('index.php/category/hapus/'.$kat->category_code)?>" onclick="return confirm('Are you sure you want to delete this category?')" class="btn btn-danger btn-sm rounded-0">Hapus</a>
							</td>
						</tr>
					<?php endforeach ?>
					</tbody>
		...
		<div class="modal-content">
			...
			<form action="<?=base_url('index.php/category/add')?>" method="post">
				...
				<div class="modal-footer justify-content-end">
					...
					<button type="button" class="btn btn-default btn-sm border rounded-0" data-dismiss="modal">Tutup</button>
				</div>
			</form>
		</div>
	</div>
