<header class="page-header">
  <div class="container-fluid">
    <h2 class="no-margin-bottom">Detail Buku</h2>
  </div>
</header>
	...
	<div class="container-fluid my-3">
		...
		<div class="card rounded-0 shadow">
			<div class="card-header">
				<a href="#add" data-toggle="modal" class="btn btn-primary btn-sm rounded-0 pull-right"><i class="fa fa-plus"></i> Tambah Buku Baru</a>
			</div>
			<div class="card-body">
			...
			<div class="modal-content">
				...
				<form action="<?=base_url('index.php/book/add')?>" method="post" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<div class="form-group row">
							<div class="col-sm-3 offset-1"><label>Cover Foto</label></div>
							<div class="col-sm-7">
